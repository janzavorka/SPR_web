/* Other variables */
		...
		window.onload = function() {
			...
			gal = gal + '<a id="imgDownload" class="downloadImageIcon" onmouseover="downloadPicturePath()" href="foto/' + year + '/' + year + '_1.jpg" download="SprintProtiRadaru' + year + '_foto1.jpg" title="Stáhnout tuto fotografii">&#128229;</a>'; //Download image
